...
class Instructions(Page):
    ...
    def vars_for_template(self):
        return dict(trials=self.session.vars["max_trials"],
                    ...
                    half_images=int(self.session.config["number_of_pictures"] / 2),
                    image_path='images/instructions_3p{}i{}m.png'.format(self.session.config["number_of_pictures"], self.session.config['modules']))
