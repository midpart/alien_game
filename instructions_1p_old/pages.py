...
class Instructions(Page):
    ...
    def vars_for_template(self):
        return dict(trials=self.session.vars["max_trials"],
                    ...
                    image_path='images/instructions_1p_old{}i{}m.png'.format(self.session.config["number_of_pictures"], self.session.config['modules'])
                    )
...
page_sequence = [Instructions, ComprehensionQuestions, ComprehensionFailed]
